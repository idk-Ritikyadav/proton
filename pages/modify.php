<?php
include('../scripts/modify-script.php');
?>
...
<?php include('../components/navbar.php'); ?>
  ...
  <main>
    ...
    <form action="../scripts/update-script.php" method="post"> <input type="hidden" name="id" value="<?php echo $row['id']; ?>">

<?php if (!empty($msg)) {
  echo $msg;
} ?>
<h3>Edit users Details Correctly</h3>
